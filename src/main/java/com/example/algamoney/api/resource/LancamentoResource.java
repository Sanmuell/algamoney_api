...
public class LancamentoResource {
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex){
		String mensagemUsuario = messageSource.getMessage("pessoa.inexistente-ou-inativa", null, LocaleContextHolder.getLocale());  // getMessage ==> Menssagem relativa ao problema
		String mensagemDesenvolvedor = ex.toString();// getCausev==> a causa do problema | Retorna a exceção 
